...
# Décommenter la ligne suivante si on veut utiliser la dernière version de HELM (v3+)
# Note: attention la commande suivante pose pb, la latest peut être une v2 patchée
...
# Décommenter la ligne suivante si on veut utiliser la dernière version de RKE
